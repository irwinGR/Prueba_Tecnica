...
!function(a) {
    ...
    function y(a, b, c, e) {
        ...
        if (j === d)
            return a.iDrawError != f && null === i && (Ia(a, 0, "Requested unknown parameter " + ("function" == typeof g.mData ? "{function}" : "'" + g.mData + "'") + " for row " + b + ", column " + c, 4),
            a.iDrawError = f),
            i;
    ...
    function M(b) {
        ...
        if (0 !== l.length)
            ...
            e[0] = a("<tr/>", {
                ...
                "valign": "top",
                "colSpan": 100,//q(b), // JALZ ajustar el mensaje de lista vacia cuando se definen dinamicamente las columnas, incidecia 641 de mantis
    ...
    function R(b, c, d) {
        if (Na(b, "aoServerParams", "serverParams", [c]),
        c && a.isArray(c)) {
            var e = {}
              , f = /(.*?)\[\]$/;
        ...
        var l = {
            ...
            "error": function(c, d, e) {
                ...
                -1 === a.inArray(!0, f) && ("parsererror" == d ? Ia(b, 0, "Invalid JSON response", 1) : 4 === c.readyState && Ia(b, 0, "Ajax error", 7)),
                oa(b, !1)
            }
        };
        b.oAjaxData = c,
        ...
        e = a.aoData.length; e > c; c++)
            ...
            !i._aFilterData) {
                ...
                f = j.length; f > d; d++)
                    ...
                    h.indexOf && -1 !== h.indexOf("&") && (tb.innerHTML = h,
                    h = ub ? tb.textContent : tb.innerText),
    ...
    function ha(a) {
        ...
        c = f.length; c > b; b++)
            d = f[b],
            d.sWidth && (d.nTh.style.width = xa(d.sWidth));
        Na(a, null, "preInit", [a]),
        N(a);
        var i = Qa(a);
    ...
    function ma(a, b, c) {
        ...
        0 > d && (d = 0)) : "next" == b ? f > d + e && (d += e) : "last" == b ? d = Math.floor((f - 1) / e) * e : Ia(a, 0, "Unknown paging action: " + b, 5);
    ...
    function qa(b) {
        ...
        l = F.outerWidth(),
        "" === p ? (H.width = "100%",
        K && (F.find("tbody").height() > y.offsetHeight || "scroll" == z.css("overflow-y")) && (H.width = xa(F.outerWidth() - s)),
        l = F.outerWidth()) : "" !== q && (H.width = xa(q),
        l = F.outerWidth()),
        ra(R, f),
        ra(function(b) {
            O.push(b.innerHTML),
        ...
        ("" === p || "" !== q) && Ia(b, 1, "Possible column misalignment", 6)) : k = "100%",
        A.width = xa(k),
        u.width = xa(k),
        ...
        w[V] = U ? s + "px" : "0px",
        I && (D[0].style.width = xa(T),
        C[0].style.width = xa(T),
    ...
    function sa(c) {
        ...
        d = 0; d < p.length; d++)
            e = h[p[d]],
            null !== e.sWidth && (e.sWidth = ua(e.sWidthOrig, u),
            v = !0);
        if (x || !v && !k && !j && m == q(c) && m == s.length)
            ...
            if (c.aoData.length)
                for (d = 0; d < p.length; d++)
                    f = p[d],
                    e = h[f],
                    a(va(c, f)).clone(!1).append(e.sContentPadding).appendTo(B);
    ...
    function za(a) {
        var b, c, d, e, f, g = [], h = Ua.ext.type.order, i = a.aoData, j = (a.aoColumns,
    ...
    function Da(b) {
        ...
        if (i.bSort && i.bSortClasses) {
            ...
            d = f.length; d > c; c++)
                e = f[c].src,
                a(kb(b.aoData, "anCells", e)).removeClass(g + (2 > c ? c + 1 : 3));
            for (c = 0,
            d = h.length; d > c; c++)
                e = h[c].src,
                a(kb(b.aoData, "anCells", e)).addClass(g + (2 > c ? c + 1 : 3))
        }
        b.aLastSort = h
    }
    function Ea(a, b) {
            ...
            if (h && h.time) {
                ...
                if (-1 === a.inArray(!1, i)) {
                    ...
                    if (!(j > 0 && h.time < +new Date - 1e3 * j) && g.length === h.columns.length) {
                        for (b.oLoadedState = a.extend(!0, {}, h),
                        h.start !== d && (b._iDisplayStart = h.start,
                        b.iInitDisplayStart = h.start),
                        h.length !== d && (b._iDisplayLength = h.length),
                        h.order !== d && (b.aaSorting = [],
                        a.each(h.order, function(a, c) {
                            b.aaSorting.push(c[0] >= g.length ? [0, c[1]] : c)
                        })),
                        h.search !== d && a.extend(b.oPreviousSearch, da(h.search)),
                        e = 0,
                        f = h.columns.length; f > e; e++) {
                            var k = h.columns[e];
                            k.visible !== d && (g[e].bVisible = k.visible),
                            k.search !== d && a.extend(b.aoPreSearchCols[e], da(k.search))
                        }
    ...
    function Ra(a, b) {
        var c = []
          , d = Sb.numbers_length
          , e = Math.floor(d / 2);
        return d >= b ? c = mb(0, b) : e >= a ? (c = mb(0, d - 2),
        c.push("ellipsis"),
        c.push(b - 1)) : a >= b - 1 - e ? (c = mb(b - (d - 2), b),
        c.splice(0, 0, "ellipsis"),
        c.splice(0, 0, 0)) : (c = mb(a - e + 2, a + e - 1),
        c.push("ellipsis"),
        c.push(b - 1),
        c.splice(0, 0, "ellipsis"),
        c.splice(0, 0, 0)),
    ...
    var Ua, Va, Wa, Xa, Ya, Za = {}, $a = /[\r\n]/g, _a = /<.*?>/g, ab = /^[\w\+\-]/, bb = /[\w\+\-]$/, cb = new RegExp("(\\" + ["/", ".", "*", "+", "?", "|", "(", ")", "[", "]", "{", "}", "\\", "$", "^", "-"].join("|\\") + ")","g"), db = /[',$\xc2\xa3\xe2\u201a\xac\xc2\xa5%\u2009\u202F\u20BD\u20a9\u20BArfk]/gi, eb = function(a) {
        return a && a !== !0 && "-" !== a ? !1 : !0
    }, fb = function(a) {
        var b = parseInt(a, 10);
    ...
    Ua = function(b) {
        ...
        return this.each(function() {
            ...
            (null === r || "" === r) && (r = "DataTables_Table_" + Ua.ext._unique++,
            this.id = r);
            ...
            j(D);
            var E = D.oClasses;
            if (p.bJQueryUI ? (a.extend(E, Ua.ext.oJUIClasses, p.oClasses),
            p.sDom === w.sDom && "lfrtip" === w.sDom && (D.sDom = '<"H"lfr>t<"F"ip>'),
            D.renderer ? a.isPlainObject(D.renderer) && !D.renderer.header && (D.renderer.header = "jqueryui") : D.renderer = "jqueryui") : a.extend(E, Ua.ext.classes, p.oClasses),
            x.addClass(E.sTable),
            ...
            var N = D.oFeatures;
            if (p.bStateSave && (N.bStateSave = !0,
            Ga(D, p),
            Ma(D, "aoDrawCallback", Fa, "state_save")),
            p.aaSorting === d) {
                var O = D.aaSorting;
                for (q = 0,
                n = O.length; n > q; q++)
            ...
            if (0 === U.length && R.length > 0 && ("" !== D.oScroll.sX || "" !== D.oScroll.sY) && (U = a("<tfoot/>").appendTo(this)),
            0 === U.length || 0 === U.children().length ? x.addClass(E.sNoFooter) : U.length > 0 && (D.nTFoot = U[0],
    ...
    var Bb = function(b, c, e, f, g) {
        ...
        j = 0,
        k = c.length; k > j; j++)
            for (i = c[j] && c[j].split ? c[j].split(",") : [c[j]],
            l = 0,
            m = i.length; m > l; l++)
    ...
    Xa(Mb, function(a, b) {
        var c = this.context;
        return a === d ? c.length && this.length ? c[0].aoData[this[0]]._details : d : (a === !0 ? this.child.show() : a === !1 ? Hb(this) : c.length && this.length && Gb(c[0], c[0].aoData[this[0]], a, b),
        this)
    }),
    ...
    Xa("order()", function(b, c) {
        var e = this.context;
        return b === d ? 0 !== e.length ? e[0].aaSorting : d : ("number" == typeof b ? b = [[b, c]] : a.isArray(b[0]) || (b = Array.prototype.slice.call(arguments)),
        this.iterator("table", function(a) {
            a.aaSorting = b.slice()
        }))
    }),
