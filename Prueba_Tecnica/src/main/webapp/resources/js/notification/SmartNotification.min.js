...
$.SmartMessageBox = function (a, b) {
  ...
  case 'text':
      ...
      g = '<input class=\'form-control\' type=\'' + a.input + '\' id=\'txt' + SmartMSGboxCount + '\' placeholder=\'' + a.placeholder + '\' value=\'' + a.inputValue + '\' style="padding: 5px;"/><br/><br/>';
      break;
  case 'textarea':
      a.inputValue = 'string' === $.type(a.inputValue) ? a.inputValue.replace(/'/g, '&#x27;')  : a.inputValue,
      g = '<textarea rows="2" style="padding: 5px;" class=\'form-control\' type=\'' + a.input + '\' id=\'txt' + SmartMSGboxCount + '\' placeholder=\'' + a.placeholder + '\' >'+a.inputValue+'</textarea><br/><br/>';
      break;
    case 'password':
  ...
  $('.botTempo').click(function () {
	  ...
	  // JALZ probar deshabilitar los botones para evitar doble click mientras procesa
	  $.each($('.botTempo'), function(i, d) {
